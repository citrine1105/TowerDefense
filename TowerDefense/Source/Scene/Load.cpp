...
void cLoadScene::Initialize() {
	...
	cImageResourceContainer::GetInstance()->GetElement(eImage_Character1)->Load(_T("./Data/Image/Game/chara.png"), 9, 3, 3, 64, 64);
	cImageResourceContainer::GetInstance()->GetElement(eImage_Character2)->Load(_T("./Data/Image/Game/chara.png"), 9, 3, 3, 64, 64);
	cImageResourceContainer::GetInstance()->GetElement(eImage_Character3)->Load(_T("./Data/Image/Game/chara.png"), 9, 3, 3, 64, 64);
